...
export default function CustomerOrderPaidEmail(props: { rows?: OrderDetail[], carrier?: Carrier, total?: number }) {
        ...
        <div className="p-16  font-sans">
          <div className="bg-white shadow-md p-8">
            ...
            <div className="flex flex-col space-y-1">
              <p>
                Hai pagato il tuo ordine. Ecco i dettagli di quello che hai ordinato.
              </p>
              <div>
                <table>
                  <tr>
                  ...
                  <tr>
                    <td></td>
                    <td className='text-center font-bold'>Totale</td>
